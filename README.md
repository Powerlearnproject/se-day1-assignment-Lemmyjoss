[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=18410958&assignment_repo_type=AssignmentRepo)
# SE_Day1
...
Waterfall: Sequential approach with distinct phases (e.g., requirements, design, implementation) flowing downwards like a waterfall. A good example is like builing a house where everything is sequencial and nothing can change one agreed. Agile: Iterative and incremental approach focused on flexibility, collaboration, and responding to change. A good example is like finishing the interior of the house where you can keep changing the color of the paint, interior deco among other things.
...
3. echnical Debt: Accrued from shortcuts or suboptimal solutions, technical debt can impede future development efforts and increase maintenance costs.
